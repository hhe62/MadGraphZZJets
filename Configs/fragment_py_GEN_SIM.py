...
# with command line options: Config/GEN/python/fragment.py --filein file:Corrected_final_merged012j_decayed.lhe --fileout file:Corrected_shower_merged012j_nholder.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --nThreads 1 --geometry DB:Extended --era Run2_2018 -n 63136 --no_exec
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(63136)
)

# Input source
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:Corrected_final_merged012j_decayed.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Config/GEN/python/fragment.py nevts:63136'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Corrected_shower_merged012j_nholder.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Corrected_shower_merged012j_nholder_inLHE.root'),
